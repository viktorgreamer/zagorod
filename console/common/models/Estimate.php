...
class Estimate extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(EstimateStage::className(), ['estimate_id' => 'estimate_id'])->andWhere(['type' => EstimateStage::TYPE_OUTPUT])->andWhere(['status' => EstimateStage::STATUS_ACTIVE])->orderBy('priority');
    }
